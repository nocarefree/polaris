...
const sortAccessibilityLabel = computed(() => i18n.value.translate('Polaris.DataTable.sortAccessibilityLabel', { direction: props.sorted ? oppositeDirection.value : direction.value }));
