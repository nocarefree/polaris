<template>
  <NpTextField v-bind="{ ...props, id: textFieldId }" aria-haspopup="listbox" :aria-active-descendant="activeOptionId"
    :aria-controls="listboxId" role="combobox" :aria-expanded="expanded" @focus="handleFocus" @blur="handleBlur"
    @change="handleChange" @update:model-value="e => $emit('update:model-value', e)">
