...
<template>
  <TransitionGroup tag="div" :css="false" :class="styles['Frame-ToastManager']" @before-enter="onToastBeforeEnter"
    @enter="onToastEnter" @leave="onToastLeave">
    <div v-for="(message, i) in toastMessages" :key="message.id" :ref="(e) => setNodeStyle(e as HTMLElement, i)">
