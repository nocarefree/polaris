<template>
  <span :class="className">
    <svg v-if="size == 'large'" viewBox="0 0 44 44" xmlns="http://www.w3.org/2000/svg">
      <path
  ...
  <span :role="hasFocusableParent ? 'status' : void 0">
    <Text v-if="hasFocusableParent || isAfterInitialMount" as="span" visually-hidden>
      {{ accessibilityLabel }}
    </Text>
  </span>
</template>
