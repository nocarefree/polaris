<template>
  <TextField :id="id" :model-value="modelValue" @update:modelValue="(e: string) => $emit('update:modelValue', e)"
    ...
    :placeholder="placeholder" :disabled="disabled" :variant="borderlessQueryField ? 'borderless' : 'inherit'"
    size="slim" :focused="focused" :label="placeholder || ''" label-hidden clear-button>
