<template>
  <svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    <path d="M8.75 10.25a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z" />
    <path d="M7.75 14.25a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z" />
    <path
      d="M9.75 10.25a.75.75 0 0 1 .75-.75h2a.75.75 0 0 1 0 1.5h-2a.75.75 0 0 1-.75-.75Z"
    />
    <path d="M10.5 12.5a.75.75 0 0 0 0 1.5h2a.75.75 0 0 0 0-1.5h-2Z" />
    <path
      fill-rule="evenodd"
