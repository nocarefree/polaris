...
import { rangeDate, HumanizedDate, isRangeDateType } from "./analytics-date-range";
...
const currentTime = computed(() => new HumanizedDate(new Date, s))
